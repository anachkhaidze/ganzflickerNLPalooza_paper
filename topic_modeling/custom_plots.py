...
import pandas as pd
from matplotlib.figure import Figure
from umap import UMAP  # Ensure this is installed: pip install umap-learn
import datamapplot  # Ensure this is installed or available in your environment

def plotting_visualize_document_datamap(
    topic_model,
    docs: List[str] = None,
...
def visualize_document_datamap_custom(
    topic_model,
    docs: List[str] = None,
    topics: List[int] = None,
    embeddings: np.ndarray = None,
    ...
    return plotting_visualize_document_datamap(
        topic_model,
        docs,
        topics,
        embeddings,
